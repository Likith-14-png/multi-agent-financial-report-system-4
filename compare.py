...
def _comparison_payload(
    ...
    return {
        ...
        "company_a_value": a_raw if not isinstance(a_raw, dict) else a_raw.get("value"),
        "company_b_value": b_raw if not isinstance(b_raw, dict) else b_raw.get("value"),
        "difference": None,
...
def compare_company_metrics(company_a: Dict[str, Any], company_b: Dict[str, Any], metric_name: Optional[str] = None) -> Dict[str, Any]:
    ...
    return {
        ...
        "company_a_value": normalized_a,
        "company_b_value": normalized_b,
